...
$(document).ready(function(){ //เมื่อโหลดเพ็จเสร็จ
				$(".btn_new").click(function(){  //เพิ่มข้อมูล
						window.location='page-product3-form.php?act=add';
				});
...
<div class="area">
  ...
  <div class="data">
    ...
    <div class="body_white">
      <div class="view_head"><!-- InstanceBeginEditable name="view_head" -->เหล็กแปรรูป<!-- InstanceEndEditable --></div>
